              ...
              <div className="space-y-10 flex-1">
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a href={`mailto:${email}`} className="text-lg md:text-xl font-black text-slate-900 dark:text-white hover:text-primary transition-colors break-all leading-tight block">
                      {email}
                    </a>
                  </div>
                </div>
